        ...
        >
            <div className="w-full flex items-center px-14 lg:px-24 py-6">
                ...
                <Link to="/" className="flex items-center">
                    <img src={logo} alt="HealthBridge" className="h-20" />
                </Link>
                ...
                <ul className="hidden md:flex items-center gap-14 text-base font-semibold text-gray-600 flex-1 justify-center tracking-wide">
                    {navLinks.map((link) => (
                        <li key={link.id}>
                            <a
                                href={link.href}
                                className={`relative hover:text-[#5ba3f8] transition-colors duration-300 pb-1.5 after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[3px] after:bg-[#5ba3f8] after:rounded-full after:transition-all after:duration-500 after:ease-in-out ${activeSection === link.id
                        ...
                        {navLinks.map((link) => (
                            <li key={link.id}>
                                <a
                                    ...
                                    className={`hover:text-[#5ba3f8] transition ${activeSection === link.id ? 'text-[#5ba3f8]' : ''
                                        }`}
                                >
                                    {link.label}
                                </a>
